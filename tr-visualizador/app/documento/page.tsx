...
function GerarTextoDoConsorcio({searchParams}: DocumentoPageProps){
  const {descricao,justificativa,numeroConsorciadas,numeroPorExtenso} = searchParams
      ...
      case 'nao':
        return (
          <>
            ...
            <p>2.5.3.Além disso, no caso vertente, não se faz presente a premissa da complexidade do objeto, uma vez que _____________________________________________________. Também não está presente o grande vulto da contratação, pois _________________________________________.<span className="orientacoes">(Adaptar a redação caso haja apenas um dos critérios – vulto ou complexidade)</span>.</p>
          </>
        );
  }
}
